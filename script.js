...
const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLScKjZsv-14m8sO4LSVTz7NtiidalxcMy5UqBF3uXHr3BCUmeA/viewform?usp=publish-editor";
...
const EVENTS = {
  ...
  nonTechnical: [
    ...
    },
    {
      title: "TEAM FUSION",
      team: "3 Members",
      about: "Team Fusion is an entertaining team-based event that brings together the world of music and cinema through a variety of fun-filled games and activities. Participants will take part in exciting challenges involving songs, movies, dialogues, music, characters, and popular cinematic moments. The activities are designed to test teamwork, creativity, memory, observation, quick thinking, and entertainment skills. With a mix of interactive games, guessing challenges, performances, and surprise activities, Team Fusion promises a lively, engaging, and enjoyable experience for everyone.",
      rules: [
        "Each team consists of 3 members.",
